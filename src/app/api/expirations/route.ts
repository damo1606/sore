...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    // Fetch without date to get the full expirationDates list
    ...
    // Collect expirations from all possible locations in the response
    ...
    // Deduplicate, sort, and convert to YYYY-MM-DD
