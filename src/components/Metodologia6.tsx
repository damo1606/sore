        ...
        <main className="p-4 sm:p-6 space-y-4 sm:space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            <div className="bg-card border border-border p-6">
              ...
              <div className="text-4xl font-bold text-gray-900">${data.spySpot.toFixed(2)}</div>
          ...
          <div className={`bg-card border-2 ${border} p-6`}>
            ...
            <div className="flex flex-wrap items-center gap-8">
              ...
              <div className="border-l-2 border-border pl-8 flex-1">
                ...
                <div className="text-base font-semibold text-gray-900">{data.m5AdjustmentLabel}</div>
